...
while len(guessed_nums) < allowed_guesses:
	...
	#if number is smaller/larger than zero then we want to throw an error	
	...
	if player_num == rand_num:
		...
		if rand_num > player_num:
			print("Nope! My number is higher than that {}.  Guess #{}".format(player_num, len(guessed_nums)))
		else:
			print("Nope! My number is lower than {}. Guess #{}.".format(player_num, len(guessed_nums))

if not rand_num in guessed_nums:
	print("Sorry!  My number was {}.".fomat(rand_num))